...
INDEX_EVAL_SCRIPT="${ROOT_DIR}/policy_network/static_pred/debug/index_prediction/analyze_best_index_predictions.py"
DOWNSTREAM_EVAL_SCRIPT="${ROOT_DIR}/policy_network/static_pred/debug/downstream_eval/analyze_topk_downstream_candidates.py"
