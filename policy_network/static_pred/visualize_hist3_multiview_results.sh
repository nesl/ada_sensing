...
"${PYTHON_BIN}" "${ROOT_DIR}/policy_network/static_pred/debug/visualize_multiview_probe_images.py" \
...
"${PYTHON_BIN}" "${ROOT_DIR}/policy_network/static_pred/debug/visualize_pred_vs_gt_index_distribution.py" \
