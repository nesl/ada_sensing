...
LABEL_DIR="${LABEL_DIR:-${ROOT_DIR}/data/ImageNet-ES-Diverse/oracle_policy_labels_l1_l7_option2_25}"
RESULTS_DIR="${RESULTS_DIR:-${ROOT_DIR}/policy_network/results_single_fixedk_l1_l7_option2_25}"
